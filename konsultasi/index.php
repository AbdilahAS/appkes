			...
			<div>
                ...
                <div style="margin-top:10px">
                    <form name="form1" method="post" action="" enctype="multipart/form-data">
						...
						<?php
                            if(isset($_POST['next'])){
                                $query = mysqli_query($connect,"insert into user (nama,jk,alamat, nohp, tgl_konsultasi) values ('$_POST[nama]', '$_POST[jk]','$_POST[alamat]','$_POST[nohp]', NOW())") or die(mysql_error());
                                if($query){
                                    
                                    $s = mysqli_query($connect,"select * from user order by id_user desc") or die(mysql_error());
